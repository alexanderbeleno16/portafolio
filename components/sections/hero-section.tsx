...
export function HeroSection() {
  return (
    ...
    >
      ...
      <div className="page-container grid min-h-[calc(100svh-5rem)] items-center gap-10 py-10 text-center sm:py-14 lg:grid-cols-[0.95fr_1.05fr] lg:gap-12 lg:py-20 lg:text-left">
        <div className="mx-auto max-w-[34rem] lg:mx-0 lg:max-w-2xl">
          ...
          <div className="motion-rise motion-delay-3 mt-9 flex flex-wrap justify-center gap-4">
            <ButtonLink href="#proyectos" className="attention-cta">
              Ver proyectos
            </ButtonLink>
            <ButtonLink
              href="#contacto"
        ...
        <div className="motion-rise motion-delay-2 relative mx-auto w-full max-w-[28rem] sm:max-w-[640px] lg:max-w-none">
